...
export function memorizedWordAction(id){
    return {type: 'TOGGLE_MEMORIZED', id};
}
export function showWordAction(id){
    return {type: 'TOGGLE_SHOW', id};
}
export function filterShowAllAction(){
    return {type: 'FILTER_SHOW_ALL'};
}
export function filterMemorizedAction(){
    return {type: 'FILTER_MEMORIZED'};
}
export function filterNeedParcticeAction(){
